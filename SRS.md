...
- Printer enumeration via HTTP
- Print ESC/POS raw commands (HEX format)
- Print ESC/POS Base64 data
- Runs as a Windows Service
- Lightweight, dependency-free HTTP server
...
**Description:** Lists all printers installed on the host Windows machine.
...
- NF-2: Dispatch print job within 150 ms under normal load.
...
- `/print` prints HEX ESC/POS commands
- `/print/base64` prints Base64 ESC/POS commands
